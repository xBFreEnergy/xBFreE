...
charmm_parser.add_argument('-v', '--version', action='version',
...
group.add_argument('-cs', dest='complex_structure', metavar='<Structure File>', default=None, type=pdb,
                   help='''Structure file of the complex. Allowed formats: *.pdb''', required=True)
group.add_argument('-cp', dest='complex_top', metavar='<Topology File>', type=charmm_topology, default=None,
...
group.add_argument('-cg', dest='complex_groups', metavar=('<receptor_mask>', '<ligand_mask>'), nargs=2, default=None,
                   type=mask,
                   help='Selection for receptor and ligand in complex topology file using charmm mask. '
...
group = charmm_parser.add_argument_group('Receptor', receptor_group_des)
group.add_argument('-rp', dest='receptor_top', metavar='<Topology File>', type=charmm_topology,
...
group = charmm_parser.add_argument_group('Ligand', ligand_group_des)
group.add_argument('-lp', dest='ligand_top', metavar='<Topology File>', type=charmm_topology,
