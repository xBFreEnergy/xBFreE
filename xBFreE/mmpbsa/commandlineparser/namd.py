...
namd_parser.add_argument('-v', '--version', action='version',
...
group.add_argument('-cp', dest='complex_top', metavar='<Topology File>', type=namd_topology, default=None,
...
group.add_argument('-rp', dest='receptor_top', metavar='<Topology File>', type=namd_topology,
...
group.add_argument('-lp', dest='ligand_top', metavar='<Topology File>', type=namd_topology,
