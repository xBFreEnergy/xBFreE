...
class BuildTopNAMD(BuildTop):
    ...
    def prmtop2prmtop(self):
        ...
        com_rec_group, com_lig_group = self.FILES.complex_groups
        # create com topology
        namd_com_top = self.read_namd_top(self.FILES.complex_top)
        ...
        if self.FILES.receptor_top:
            namd_rec_top = self.read_namd_top(self.FILES.receptor_top)
        ...
        # create lig topology
        if self.FILES.receptor_top:
            namd_lig_top = self.read_namd_top(self.FILES.ligand_top)
    ...
    def read_namd_top(self, top_file, molid='complex'):
        # load topology
